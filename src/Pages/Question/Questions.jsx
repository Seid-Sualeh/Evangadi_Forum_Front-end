...
function Question() {
  ...
  useEffect(() => {
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        // ✅ Detect and use correct array key
        const questionList = Array.isArray(res.data.message)
          ? res.data.message
          : res.data.questions || [];
  ...
  // ✅ Update questions dynamically from child component
  const handleQuestionUpdate = (questionId, newTitle, newDescription) => {
    setQuestions((prevQuestions) =>
      prevQuestions.map((question) =>
        question.questionid === questionId
  ...
  // ✅ Safe filter (prevents .filter crash)
